...
DEFAULT_TRANSITIONS: dict[str, set[str]] = {
    "queued": {"scheduled", "running", "cancelled", "timeout"},
    "scheduled": {"queued", "running", "cancelled", "timeout"},
    "running": {"succeeded", "failed", "retry_wait", "cancelled", "paused", "timeout", "ttl_expired"},
    "retry_wait": {"queued", "running", "failed", "cancelled", "timeout"},
